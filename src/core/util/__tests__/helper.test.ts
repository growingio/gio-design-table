...
describe('test computeArrayPosition', () => {
  ...
  it('should renturn 0~11 when min~max from -70~100 ', () => {
  ...
  it('should renturn 0~5 when max<=0', () => {
  ...
  it('should renturn 6~10 when min>=0', () => {
  ...
  it('should renturn 5 when max=min=0', () => {

    const d0 = computeArrayPosition(11, 0, 0, 0);
    expect(d0).toStrictEqual(5);
  })
  it('should renturn 6 when max=min and min>0', () => {
    const d6 = computeArrayPosition(11, 100, 100, 100);
    expect(d6).toStrictEqual(6);
  })
  it('should renturn 4 when max=min and max<0', () => {
